...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        graph = new Graph(  new File("/home/competelri/comp261/assig-1-maven-main 2/assig-1-maven-main/data/stops.txt"), 
                            new File("/home/competelri/comp261/assig-1-maven-main 2/assig-1-maven-main/data/stop_patterns.txt"));
